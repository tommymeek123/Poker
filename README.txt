...
The point of this project is to practice with the functional programming paradigm
by using higher order functions like map and reduce along with other functional
hallmarks like list comprehensions.
